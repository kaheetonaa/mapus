$(document).ready(function(){
  ...
  function liveLocation() {
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(function(position){
        var icon = L.icon({
          iconUrl: '/static/liveLocation.svg',
          iconSize:     [24, 24],
          iconAnchor:   [12, 12],
        });
    ...
    if (checkAuth() != false) {
      ...
      $.get('https://nominatim.openstreetmap.org/search?viewbox='+coordinates+'&format=geocodejson&limit=20&bounded=1&amenity='+locationtype+'&exclude_place_ids='+JSON.stringify(place_ids), function(data) {
        ...
        var marker_icon = L.icon({
          iconUrl: '/static/'+locationtype+'-marker.svg',
          iconSize:     [30, 30],
          iconAnchor:   [15, 30],
          shadowAnchor: [4, 62],
          popupAnchor:  [-3, -76]
  ...
  function saveNearby() {
    ...
    if (checkAuth() != false) {
      ...
      inst.marker.bindTooltip('<h1>'+inst.name+'</h1><div class="shape-data"><h3><img src="/static/marker-small-icon.svg">'+inst.lat.toFixed(5)+', '+inst.lng.toFixed(5)+'</h3></div><br><div class="arrow-down"></div>', {permanent: false, direction:"top", interactive:false, bubblingMouseEvents:false, className:"create-shape-flow", offset: L.point({x: 0, y: -35})});
    }
  }
  ...
  function saveForm(e) {
    ...
    if (checkAuth() != false) {
      ...
      if (inst.type == "area") {
        ...
        inst.trigger.bindTooltip('<h1>'+inst.name+'</h1><h2>'+inst.desc+'</h2><div class="shape-data"><h3><img src="/static/area-icon.svg">'+inst.area+' km&sup2;</h3></div><div class="shape-data"><h3><img src="/static/perimeter-icon.svg">'+inst.distance+' km</h3></div><div class="arrow-down"></div>', {permanent: false, direction:"top", interactive:false, bubblingMouseEvents:false, className:"create-shape-flow", offset: L.point({x: -15, y: 18})});
        ...
        inst.trigger.bindTooltip('<h1>'+inst.name+'</h1><h2>'+inst.desc+'</h2><div class="shape-data"><h3><img src="/static/distance-icon.svg">'+inst.distance+' km</h3></div><div class="arrow-down"></div>', {permanent: false, direction:"top", interactive:false, bubblingMouseEvents:false, className:"create-shape-flow", offset: L.point({x: -15, y: 18})});
        db.ref("rooms/"+room+"/objects/"+currentid).update({
          distance: inst.distance,
          name: inst.name,
          desc: inst.desc,
        ...
        inst.trigger.bindTooltip('<h1>'+inst.name+'</h1><h2>'+inst.desc+'</h2><div class="shape-data"><h3><img src="/static/marker-small-icon.svg">'+inst.lat.toFixed(5)+', '+inst.lng.toFixed(5)+'</h3></div><div class="arrow-down"></div>', {permanent: false, direction:"top", interactive:false, bubblingMouseEvents:false, className:"create-shape-flow", offset: L.point({x: 0, y: -35})});
        db.ref("rooms/"+room+"/objects/"+currentid).update({
          name: inst.name,
          desc: inst.desc,
          completed: true
  ...
  function renderObjectLayer(object) {
    ...
    if ($(".annotation-item[data-id='"+object.id+"']").length == 0) {
      ...
      if (object.type == "line") {
        ...
        $("#annotations-list").prepend('<div class="annotation-item" data-id="'+object.id+'"><div class="annotation-name"><img class="annotation-arrow" src="/static/arrow.svg">'+icon+'<span>'+object.name+'</span><img class="delete-layer" src="/static/delete.svg"></div><div class="annotation-details annotation-closed"><div class="annotation-description">'+object.desc+'</div><div class="annotation-data"><div class="annotation-data-field"><img src="/static/distance-icon.svg">'+object.distance+' km</div></div></div></div>');
        ...
        $("#annotations-list").prepend('<div class="annotation-item" data-id="'+object.id+'"><div class="annotation-name"><img class="annotation-arrow" src="/static/arrow.svg">'+icon+'<span>'+object.name+'</span><img class="delete-layer" src="/static/delete.svg"></div><div class="annotation-details annotation-closed"><div class="annotation-description">'+object.desc+'</div><div class="annotation-data"><div class="annotation-data-field"><img src="/static/area-icon.svg">'+object.area+' km&sup2;</div><div class="annotation-data-field"><img src="/static/perimeter-icon.svg">'+object.distance+' km</div></div></div></div>');
        ...
        $("#annotations-list").prepend('<div class="annotation-item" data-id="'+object.id+'"><div class="annotation-name"><img class="annotation-arrow" src="/static/arrow.svg">'+icon+'<span>'+object.name+'</span><img class="delete-layer" src="/static/delete.svg"></div><div class="annotation-details annotation-closed"><div class="annotation-description">'+object.desc+'</div><div class="annotation-data"><div class="annotation-data-field"><img src="/static/marker-small-icon.svg">'+object.lat.toFixed(5)+', '+object.lng.toFixed(5)+'</div></div></div></div>');
      }
    } else {
      ...
      if (object.type == "line") {
        ...
        layer.find(".annotation-data").html('<div class="annotation-data-field"><img src="/static/distance-icon.svg">'+object.distance+' km</div>');
      } else if (object.type == "area") {
        layer.find(".annotation-name span").html(object.name);
        layer.find(".annotation-description").html(object.desc);
        layer.find(".annotation-data").html('<div class="annotation-data-field"><img src="/static/area-icon.svg">'+object.area+' km&sup2;</div><div class="annotation-data-field"><img src="/static/perimeter-icon.svg">'+object.distance+' km</div>');
      } else if (object.type == "marker") {
        layer.find(".annotation-name span").html(object.name);
        layer.find(".annotation-description").html(object.desc);
        layer.find(".annotation-data").html('<div class="annotation-data-field"><img src="/static/marker-small-icon.svg">'+object.lat.toFixed(5)+', '+object.lng.toFixed(5)+'</div>');
      }
    }
  }
  ...
  function addShapeInfo(snapshot, key) {
    if (snapshot.type != "draw" && snapshot.type != "marker") {
      ...
      if (checkAuth() != false) {
        ...
        if (inst.type == "line") {
          centermarker.bindTooltip('<h1>'+inst.name+'</h1><h2>'+inst.desc+'</h2><div class="shape-data"><h3><img src="/static/distance-icon.svg">'+inst.distance+' km</h3></div><div class="arrow-down"></div>', {permanent: false, direction:"top", interactive:false, closeOnClick:false, autoclose:false, bubblingMouseEvents:true, className:"create-shape-flow tooltip-off", offset: L.point({x: -15, y: 18})});
      ...
      if (snapshot.type == "draw" || snapshot.type == "line" || snapshot.type == "area") {
        ...
        if (objects.filter(function(result){
          ...
          if (snapshot.m_type == "none") {
            ...
            var marker_icon = L.icon({
              iconUrl: '/static/'+snapshot.m_type+'-marker.svg',
              iconSize:     [30, 30],
              iconAnchor:   [15, 30],
              shadowAnchor: [4, 62],
              popupAnchor:  [-3, -76]
